...
filemenu.add_separator()
filemenu.add_command(label="Unit Conversion", command=unit)
...
btnPM = Button(calc, text=chr(177), width=6, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
               command=added_value.mathsPM).grid(row=1, column=1, pady=1)
...
btnEquals = Button(calc, text="=", width=13, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
                   command=added_value.sum_of_total).grid(row=5, column=2, columnspan=2, pady=1)

# ======================== Scientific =============================
lblDisplay = Label(calc, text="SCIENTIFIC CALCULATOR", bd=30, font=('arial', 24, 'bold'), justify=CENTER)
...
btnCosh = Button(calc, text="cosh", width=6, height=2, font=('arial', 20, 'bold'), bd=4, command=added_value.cosh).grid(
    row=2, column=5, pady=1)

btntanh = Button(calc, text="tanh", width=6, height=2, font=('arial', 20, 'bold'), bd=4, command=added_value.tanh).grid(
...
btnExp = Button(calc, text="Exp", width=6, height=2, font=('arial', 20, 'bold'), bd=4, command=added_value.exp).grid(
...
uniplay = Label(calc, text="CONVERSION", font=('arial', 24, 'bold'), bd=30, justify=CENTER)
uniplay.grid(row=0, column=9, columnspan=4)

btnmins = Button(calc, text="min/sec", width=10, height=2, font=('arial', 20, 'bold'), bd=4,
                 command=added_value.mins).grid(row=1, column=9, columnspan=2, pady=1)
btnsmin = Button(calc, text="sec/min", width=10, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
                 command=added_value.smin).grid(row=2, column=9, columnspan=2, pady=1)

btnfc = Button(calc, text="far/celius", width=10, height=2, font=('arial', 20, 'bold'), bd=4,
               command=added_value.ftc).grid(row=3, column=9, columnspan=2, pady=1)
btncf = Button(calc, text="celius/far", width=10, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
               command=added_value.ctf).grid(row=4, column=9, columnspan=2, pady=1)

btnkp = Button(calc, text="kg/pound", width=10, height=2, font=('arial', 20, 'bold'), bd=4,
               command=added_value.ktp).grid(row=5, column=9, pady=1)
btnpk = Button(calc, text="pound/kg", width=10, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
               command=added_value.ptk).grid(row=1, column=11, columnspan=2, pady=1)

bthpa = Button(calc, text="hectare/acre", width=10, height=2, font=('arial', 20, 'bold'), bd=4,
               command=added_value.hta).grid(row=2, column=11, columnspan=2, pady=1)
btaph = Button(calc, text="acre/hectare", width=10, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
               command=added_value.ath).grid(row=3, column=11, columnspan=2, pady=1)

btmy = Button(calc, text="meter/feet", width=10, height=2, font=('arial', 20, 'bold'), bd=4, bg="powder blue",
              command=added_value.mtf).grid(row=5, column=11, columnspan=2, pady=1)
btym = Button(calc, text="feet/meter", width=10, height=2, font=('arial', 20, 'bold'), bd=4,
              command=added_value.ftm).grid(row=4, column=11, columnspan=2, pady=1)
